# Generated by Django 3.2.7 on 2021-12-11 08:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('t_shirt_size', models.CharField(choices=[('S', 'S'), ('M', 'M'), ('L', 'L'), ('XL', 'XL'), ('XXL', 'XXL')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='potosioBackend.clienttype')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
